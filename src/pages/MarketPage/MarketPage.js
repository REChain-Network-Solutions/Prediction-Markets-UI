...
export const MarketPage = () => {
  ...
  return <>
    ...
    <div style={{ marginTop: 50 }}>
      ...
      {!appConfig.KNOWN_ORACLES.includes(oracle) && <Alert showIcon message={<Trans i18nKey="pages.market.unknown_oracle">This market uses an oracle <a style={{ color: '#fff' }} href={`https://${appConfig.ENVIRONMENT === 'testnet' ? 'testnet' : ''}explorer.oREChain.org/#${oracle}`} target="_blank" rel="noopener">{oracle}</a> that is unknown to this website, trade with care.</Trans>} type="warning" />}
