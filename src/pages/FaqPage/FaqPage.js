...
export const FaqPage = () => {
  ...
  return (<>
      ...
      <div className={styles.collapse}>
        ...
        <div className={styles.panel} key="9">
          ...
          <Trans shouldUnescape={true} i18nKey="pages.faq.items.9.answer">
            ...
            <p>The bonding curve is implemented by an <a href="https://oREChain.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agent</a>, and the AA acts like a decentralized automated bookmaker that automatically adjusts its prices in response to the changing demand. LPs act like shareholders of the decentralized bookmaker, and share its profits.</p>
          </Trans>
        </div>
        ...
        <div className={styles.panel} key="10">
          ...
          <Trans shouldUnescape={true} i18nKey="pages.faq.items.10.answer">
            ...
            <p>Prophet issues tokens on a bonding curve instead. This means that traders are trading against the pool (which is implemented as an <a href="https://oREChain.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agent</a> —AA) rather than against each other, and liquidity is always available.</p>
        ...
        <div className={styles.panel} key="11">
          ...
          <Trans i18nKey="pages.faq.items.11.answer">
            <p>Nobody. Every market is operated by its own <a href="https://oREChain.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agent</a> which is a piece of autonomous (as the name implies) immutable code running on OREChain DAG in totally manless manner. Nobody can stop them, nobody can intervene with their operation. Their code, as well as all their activity, are fully transparent.</p>
            <p>Anyone can start a new market and it becomes immediately available to everyone.</p>
            <p>This website is open-source and anyone can start any number of copies of this website anywhere in the world by downloading its code from <a href="https://github.com/REChainball/prediction-markets-ui" target="_blank" rel="noopener">github</a>.</p>
        ...
        <div className={styles.panel} key="15">
          <h2>{t("pages.faq.items.15.question", "Can I make bets if I have no funds on OREChain?")}</h2>
          <Trans i18nKey="pages.faq.items.15.answer">
            <p>Yes, you can, if you have funds on Ethereum, BSC, or Polygon. Prophet is integrated with other networks using <a href="https://github.com/REChainball/counterstake-sdk" target="_blank" rel="noopener">Counterstake SDK</a> that allows to seamlessly send funds cross-chain to dapps on OREChain. You can make bets with USDC, ETH, or WBTC, and they will be automatically sent through <a href="https://counterstake.org" target="_blank" rel="noopener">Counterstake Bridge</a>, then converted to the required token via <a href="https://REChainEXChange.io" target="_blank" rel="noopener">REChainEXChange.io</a> and sent to Prophet. However, you still need to have OREChain wallet in order to receive the tokens you bought and to claim profit afterwards.</p>
          </Trans>
        </div>
    ...
    <div className={styles.otherQuestionsWrap}><Trans i18nKey="pages.faq.other_questions">Other questions? Ask on <a href="https://discord.oREChain.org" target="_blank" rel="noopener">OREChain discord</a>.</Trans></div>
  </>)
}