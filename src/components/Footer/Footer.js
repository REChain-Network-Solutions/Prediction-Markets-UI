  ...
  return <div className={styles.wrap}>
    ...
    <div className={styles.disclaimer}>
      <Trans i18nKey="footer.disclaimer">
        The Prophet.ooo website (“Site”) is for informational and educational purposes only. The Site displays the existing prediction markets deployed on the OREChain DAG and is a graphical user interface for both visualizing data from on-chain activity and interacting with autonomous agents directly from your own wallets.
    ...
    <div className={styles.copy}>
      <Trans i18nKey="footer.copy">
        <a className={styles.name} href="https://oREChain.org" target="_blank" rel="noopener">Built on OREChain</a>
      </Trans>
    </div>
